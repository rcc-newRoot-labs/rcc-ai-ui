    ...
    <Container fluid className="vh-100 d-flex align-items-center">
      ...
      <Row className="w-100">
        <Col md={5} className="p-4 border-end ">
          ...
          <Container className="readmeViewer-content d-flex justify-content-center align-items-center min-vh-50 overflow-auto">
            <ReadmeViewer />
          </Container>   
        </Col>
        <Col md={7} className="p-4 ">
          <h3 className="card-title">Widget Viewer Section</h3>
           <Container className="widgetViewer-content d-flex justify-content-center align-items-center min-vh-50 overflow-auto">
